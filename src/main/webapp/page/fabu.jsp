...
<DIV class=box>
<FORM method="post" action="addHouse" enctype="multipart/form-data">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD><INPUT class="text" type="text" name="floorage"></TD>
  </TR>
  <TR>
  ...
  <TR>
    ...
    <TD><INPUT class="text" type="text" name="contact"></TD>
  </TR>
  <TR>
  ...
  <TR>
    <TD class="field">插入图片：</TD>
    <TD><input type="file" name="insertFile"></TD>
  </TR>
  </TBODY></TABLE>
<DIV class=buttons><INPUT onclick="document.location='list.htm'" value="立即发布" type="submit">
